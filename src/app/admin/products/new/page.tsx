...
import { createProduct, ProductFormData, VariantFormData } from "../actions";
...
// Suggested sizes for each category
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {variants.length === 0 ? (
            <div className="text-center py-8 bg-gray-50 rounded-lg">
              ...
              <p className="text-sm text-gray-400 mt-1">
                Add sizes if your product comes in different options. If not, the base price will be used.
              </p>
            </div>
          ) : (
        ...
        {/* Base Pricing (shown when no variants) */}
        <div className="bg-white rounded-xl shadow-sm border p-6 space-y-4">
              ...
              {specs.map((spec, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    placeholder="Value (e.g., 2m x 1.5m)"
                    className="flex-1 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                  />
                  <button
                    type="button"
